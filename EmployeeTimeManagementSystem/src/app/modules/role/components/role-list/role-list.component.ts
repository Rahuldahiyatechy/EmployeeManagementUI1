...
@Component({
 ...
 export class RoleListComponent implements OnInit {
  ...
  constructor(private router: Router, private tfrGridService: TfrGridService, private roleService: RoleService) { this.self = this; }
  ...
  navigateTo = (RoleId) => {
    //debugger;
    this.router.navigateByUrl(`RoleEdit/edit/${RoleId}`);
  }
  ...
  navigateToCreateNew = () => {
  //debugger;
    this.router.navigateByUrl(`RoleEdit`);
